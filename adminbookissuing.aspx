                            ...
                            <div class=" col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button ID="Button2" CssClass="btn btn-dark" runat="server" Text="GO" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <asp:TextBox CssClass="form-control" TextMode="Date" ID="TextBox10" runat="server" placeholder="Start Date"></asp:TextBox>
                             ...
                             <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                     <asp:TextBox Class="form-control" TextMode="Date" ID="TextBox5" runat="server" placeholder="End Date"></asp:TextBox>
                                 </div>
                             </div>
